...
A. A relative path refers to a location that is relative to a current directory. Relative paths make use of two special symbols, a dot (.) and a double-dot (..), which translate into the current directory and the parent directory

2. What does an absolute path start with your operating system?
A.An absolute path begins with a drive letter followed by a colon, such as / or C:/

3.What do the functions os.getcwd() and os.chdir() do?
A.os.getcwd() method tells us the location of current working directory (CWD).chdir() method in Python used to change the current working directory to specified path. 
